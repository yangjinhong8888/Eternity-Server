package com.jinhongs.eternity.admin.web.utils;
...
public class ResultUtils {
    ...
    public static <T> ResponseEntity<Result<T>> badRequest() {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(buildErrorResult(ResultCode.BAD_REQUEST));
    }
    ...
    public static <T> ResponseEntity<Result<T>> badRequest(String message) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(buildErrorResult(ResultCode.BAD_REQUEST.getCode(), message));
    }
    ...
    public static <T> ResponseEntity<Result<T>> internalServerError() {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(buildErrorResult(ResultCode.INTERNAL_SERVER_ERROR));
    }
    ...
    public static <T> ResponseEntity<Result<T>> internalServerError(String message) {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(buildErrorResult(ResultCode.INTERNAL_SERVER_ERROR.getCode(), message));
    }
