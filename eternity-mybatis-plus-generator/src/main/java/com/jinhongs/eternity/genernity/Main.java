...
public class Main {
    ...
    public static void allGenerator(){
        ...
        FastAutoGenerator.create(
                        "jdbc:mysql://localhost:3306/eternity?serverTimezone=UTC",
                ...
                .packageConfig(builder -> {
                    builder.parent("com.jinhongs")                                      // 设置父包名
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("user_info", "user_auth", "role", "permission", "user_role", "role_permission", "articles"
